...
BEGIN
        DBMS_NETWORK_ACL_ADMIN.CREATE_ACL('CR-Release-3-00.xml', 'HTTP access ACL', 'DMLATEST', TRUE, 'connect');
        DBMS_NETWORK_ACL_ADMIN.ADD_PRIVILEGE('CR-Release-3-00.xml', 'DMLATEST', TRUE, 'connect');
        DBMS_NETWORK_ACL_ADMIN.ADD_PRIVILEGE('CR-Release-3-00.xml', 'DMLATEST', TRUE, 'resolve');
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element name="Info">
          <xs:complexType>
            <xs:sequence>
              <xs:element type="xs:float" name="total_rules"/>
              <xs:element type="xs:float" name="cost_to_scan"/>
              <xs:element type="xs:float" name="cost_to_remediate"/>
              <xs:element type="xs:float" name="rule_low"/>
              <xs:element type="xs:float" name="rule_medium"/>
              <xs:element type="xs:float" name="rule_high"/>
              <xs:element type="xs:float" name="rule_critical"/>
              <xs:element type="xs:float" name="rule_insane"/>
              <xs:element type="xs:float" name="rule_default"/>
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element name="Info">
          <xs:complexType>
            <xs:sequence>
              <xs:element type="xs:string" name="os_name"/>
              <xs:element type="xs:string" name="os_version"/>
              <xs:element type="xs:string" name="os_architecture"/>
              <xs:element type="xs:string" name="username"/>
              <xs:element type="xs:string" name="ip_addr"/>
            </xs:sequence>
          </xs:complexType>
        </xs:element>
      </xs:sequence>
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element name="Info">
          <xs:complexType>
            <xs:sequence>
              <xs:element type="xs:string" name="execution_mode"/>
              <xs:element type="xs:string" name="execution_status"/>

              <xs:element type="xs:float" name="total_rules_count"/>
              <xs:element type="xs:float" name="success_rules_count"/>
              <xs:element type="xs:float" name="failure_rules_count"/>
              <xs:element type="xs:float" name="manual_rules_count"/>

              <xs:element type="xs:float" name="high_severity_success"/>
              <xs:element type="xs:float" name="high_severity_failure"/>
              <xs:element type="xs:float" name="high_severity_manual"/>

              <xs:element type="xs:float" name="medium_severity_success"/>
              <xs:element type="xs:float" name="medium_severity_failure"/>
              <xs:element type="xs:float" name="medium_severity_manual"/>

              <xs:element type="xs:float" name="low_severity_success"/>
              <xs:element type="xs:float" name="low_severity_failure"/>
              <xs:element type="xs:float" name="low_severity_manual"/>
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element name="Info">
          <xs:complexType>
            <xs:sequence>
              <xs:element type="xs:string" name="rule_number"/>
              <xs:element type="xs:string" name="rule_id"/>
              <xs:element type="xs:string" name="rule_console"/>
              <xs:element type="xs:string" name="execution_status"/>
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element name="Info">
          <xs:complexType>
            <xs:sequence>
              <xs:element type="xs:string" name="public_key"/>
              <xs:element type="xs:string" name="passphrase"/>
              <xs:element type="xs:string" name="cert_cert"/>
              <xs:element type="xs:string" name="cert_pem"/>
              <xs:element type="xs:string" name="cert_pfx"/>
              <xs:element type="xs:string" name="private_pem"/>
            </xs:sequence>
          </xs:complexType>
        </xs:element>
      </xs:sequence>
...
CREATE TABLE CPE_RESOURCE_LOG
  (
    ...
    OVERALL_STATUS       VARCHAR2(8) ,
    OVERALL_INFO         VARCHAR2(64) ,
    PROFILE_REF_ID	 NUMBER (16),
    PROFILE_STRENGTH	 NUMBER (8,3),
    RAW_LOG 		 CLOB ,
...
CREATE TABLE CPE_RES_MGMT_EXCEPTION
  (
    ...
    RESOURCE_MGMT_ID    NUMBER (16) NOT NULL ,
    PROFILE_MEMBER_ID   NUMBER (16) NOT NULL,
    OVERRIDE_TYPE	CHAR(1), -- values "S"can-only, s"K"ip this rule, "M"ark successful
    OVERRIDE_CREATED_BY NUMBER(16),
    OVERRIDE_START_DATE	TIMESTAMP,
    OVERRIDE_END_DATE   TIMESTAMP,
    IS_ACTIVE           CHAR (1) ,
...
ALTER TABLE CPE_RES_MGMT_EXCEPTION ADD CONSTRAINT CPE_RES_MGMT_EXCEPTION_CHK2 CHECK (override_type IN ('S','K','M') );
...
begin
      ...
      if (v_status = 'N') THEN raise_application_error( -20028, 'Error : 20028'); end if;
           ...
           begin
             select id into v_id from cpe_profile_info where profile_id = :new.profile_id;
           exception
           ...
           if v_id = 0 then
              begin
                ...
                values ( :new.profile_id , xmltype(create_profile_info(:new.profile_id)) , 
                         xmltype(create_profile_data(:new.profile_id)) ,create_profile_mof(:new.profile_id)  );
                commit;
              exception
             ...
             begin
                ...
                set PROFILE_INFO=xmltype(create_profile_info(:new.profile_id)) ,
                    profile_data = xmltype(create_profile_data(:new.profile_id)) ,
                    profile_mof = create_profile_mof(:new.profile_id)
                where id = v_id;
                commit;
              exception
                 when others then raise_application_error( -20000, 'Error : 20000' || :new.id );
             end;
           end if;
      ...
      begin
         ...
         where a.is_active='Y' and b.id = a.profile_id and b.id = :new.profile_id;
      exception
      ...
      begin
         ...
         where b.is_active= 'Y' and a.id = :new.profile_id and b.id = a.resource_type_id;
      exception
      ...
      if v_s2 = 0 then 
        update cpe_profile set profile_strength = v_s2 , profile_ref_id = v_id where id = :new.profile_id;
        commit;
      else
        update cpe_profile set profile_strength = ((v_s1 / v_s2) * 100) , profile_ref_id = v_id where id = :new.profile_id;
        commit;
      end if;
end;
/
...
begin
     ...
     if :new.schedule_start_time < sysdate then
      ...
      begin
       ...
       begin
         select id ,resource_type_id into v_id,v_prof  from cpe_profile where id = :new.profile_id and is_active = 'Y';
         exception
...
begin
      ...
      if :new.parent_id is not null then
         ...
         if nvl(:new.quota_expiry_date,sysdate + 1) > v_date then
            raise_application_error ( -20000, 'Error: Quota expiry date can not exceed parent' );
         end if;
       end if;
       ...
       if :new.parent_id is not null then
          ...
          if v_org = 0 then 
             raise_application_error ( -20000,'Error: User can not belong to internal org');
          end if;
       end if;   
...
begin
      ...
      if (v_status = 'N') THEN raise_application_error( -20028, 'Error : 20028'); end if;
          ...
          begin
             select id into v_id from cpe_profile_info where profile_id = :old.profile_id;
           exception
             when no_data_found then v_id := 0;
           end;
           if v_id = 0 then
              begin
                insert into cpe_profile_info (profile_id,PROFILE_INFO, profile_data, profile_mof)
                values ( :old.profile_id , xmltype(create_profile_info(:old.profile_id)) , 
                         xmltype(create_profile_data(:old.profile_id)) ,create_profile_mof(:old.profile_id)  );
                commit;
              exception
                 when others then raise_application_error( -20000, 'Error : 20000' || :old.id );
              end;
             ...
             begin
                update cpe_profile_info
                set PROFILE_INFO=xmltype(create_profile_info(:old.profile_id)) ,
                    profile_data = xmltype(create_profile_data(:old.profile_id)) ,
                    profile_mof = create_profile_mof(:old.profile_id)
                where id = v_id;
                commit;
              exception
                 when others then raise_application_error( -20000, 'Error : 20000' || :old.id );
     ...
     begin
         select nvl(sum(case a.criticality_id when 5 then 1 when 6 then 2 when 7 then 3 else 0 end),0) into v_s1
         from cpe_profile_member a , cpe_profile b
         where a.is_active='Y' and b.id = a.profile_id and b.id = :old.profile_id;
      exception
         when others then v_s1 := 0 ;
      end;   
      begin
         select nvl(b.ref_profile_id,0) into v_id
         from cpe_resource_type b, cpe_profile a  
         where b.is_active= 'Y' and a.id = :old.profile_id and b.id = a.resource_type_id;
      exception
          when others then v_id := 0;
      end;
      begin 
      ...
      if v_s2 = 0 then 
        update cpe_profile set profile_strength = v_s2 , profile_ref_id = v_id where id = :old.profile_id;
        commit;
      else
        update cpe_profile set profile_strength = ((v_s1 / v_s2) * 100) , profile_ref_id = v_id where id = :old.profile_id;
        commit;
      end if;          
...
--    end if; 
    if (:old.is_active = 'Y' AND :new.is_active = 'N' ) THEN 
       ...
       loop
          ...
          insert into cpe_usage_log ( event_trigger_by, user_id, resource_id, event_type, event_trigger, event_value, created_by )
          values ( :new.owner_id, v_id, :new.id , 'del_resource', 'UN-Registered resource', -1 , v_name) ;
...
CREATE OR REPLACE TRIGGER "CPE_RESOURCE_LOG_TRIG2" before update on CPE_RESOURCE_LOG for each row
begin
      if :new.updated_by is null then select user into :new.updated_by from dual ; end if;
      select SYSDATE into :new.UPDATE_DATE from dual; end;
/
ALTER TRIGGER "CPE_RESOURCE_LOG_TRIG2" ENABLE;
/
...
begin
      ...
      if updating ('ID') or updating('resource_id') or
         updating('run_remediate') or updating('schedule_start_time') or updating('schedule_create_time') or
         updating('run_cost_scan') or updating('run_cost_remediate')
      then
            ...
            if nvl(c_date,sysdate+1) > sysdate then  
               if updating ('quota_expiry_date' ) then
                  if ((:new.quota_expiry_date is not null) AND
                     ...
                     then c_date := :new.quota_expiry_date; end if;
               end if;
...
begin
   ...
   if :new.parent_id is not null then
    ...
    if :new.parent_id is not null then
       if updating ('quota_resource') OR updating ('quota_runs_per_month') OR updating ('quota_cost_per_month') then
          if updating ('quota_expiry_date') then
             if (:new.quota_expiry_date is not null) then
                select sysdate into :new.quota_expiry_date from dual;
             end if;
          else
             if nvl(:old.quota_expiry_date,sysdate+1)  < sysdate then
          ...
          loop
               ...
               if updating ('quota_expiry_date' ) then
                  if ((:new.quota_expiry_date is not null) AND
                     ...
                     then l_res2.quota_expiry_date := :new.quota_expiry_date; end if;
               end if;
               if updating ('quota_resource' ) then
              ...
              fetch l_c into l_res1; exit when l_c%notfound;
               if updating ('quota_expiry_date' ) then
                  if ((:new.quota_expiry_date is not null) AND
                     ...
                     then l_res1.quota_expiry_date := :new.quota_expiry_date; end if;
               end if;
               if updating ('quota_resource' ) then
      ...
      if inserting then
         if :new.user_expiry_date is null then 
            ...
            if :new.user_expiry_date > sysdate + 5 then
               raise_application_error (-20000,'Error: Interim User life is only 5 days');
            end if;
        end if;
         if :new.quota_resource is null then 
            ...
            if :new.quota_resource > 2 then
               raise_application_error (-20000,'Error: Interim User can only register 2 resources');
            end if;
        end if;
         if :new.quota_runs_per_month is null then 
            ...
            if :new.quota_runs_per_month > 5 then
               raise_application_error (-20000,'Error: Interim User can only run 5 profiles');
            end if;
        end if;
      end if;  
      if updating then
